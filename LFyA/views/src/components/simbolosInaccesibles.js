class simbolosInaccesibles {
    ...
    imprimir() {
		...
		p15.appendChild(n15);
		var element15 = document.getElementById("hack.3");
		...
		p16.appendChild(n16);
		var element16 = document.getElementById("hack.3");
		...
		p17.appendChild(n17);
		var element17 = document.getElementById("hack.3");
        ...
        for (var j in this.noTerminalesF) {
			...
			p18.appendChild(n18);
			var element18 = document.getElementById("hack.3");
