 class simbolosMuertosClase {
     ...
     accion() {
		...
		p8.appendChild(n8);
		var element8 = document.getElementById("hack.2");
		...
		p9.appendChild(n9);
		var element9 = document.getElementById("hack.2");
		...
		p10.appendChild(n10);
		var element10 = document.getElementById("hack.2");
		element10.appendChild(p10); 
         ...
         for (var j in this.NTF) {
			...
			p11.appendChild(n11);
			var element11 = document.getElementById("hack.2");
